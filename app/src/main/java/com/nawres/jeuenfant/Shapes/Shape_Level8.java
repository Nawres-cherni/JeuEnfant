...
public class Shape_Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shape__level8);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("octogon")) {
                    Toast.makeText(Shape_Level8.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Shape_Level9.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Shape_Level8.this,
