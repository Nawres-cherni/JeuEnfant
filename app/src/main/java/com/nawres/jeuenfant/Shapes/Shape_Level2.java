...
public class Shape_Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shape__level2);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radioShapeButton == truth) {
                    Toast.makeText(Shape_Level2.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Shape_Level3.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Shape_Level2.this,
