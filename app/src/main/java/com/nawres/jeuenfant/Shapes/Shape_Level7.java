...
public class Shape_Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shape__level7);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("parallelogram")) {
                    Toast.makeText(Shape_Level7.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Shape_Level8.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Shape_Level7.this,
