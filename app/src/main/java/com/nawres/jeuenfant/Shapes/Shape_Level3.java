...
public class Shape_Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shape__level3);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("rectangle")) {
                    Toast.makeText(Shape_Level3.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Shape_Level4.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Shape_Level3.this,
