...
public class Animal_Level6 extends AppCompatActivity {
    private RadioGroup radioShapesGroup;
    private RadioButton radioShapeButton;
    private RadioButton truth;
    private Button btnDisplay_level6;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_animal__level6);
        background();
        addListenerOnButton();
    }
    ...
    private void background (){
        LinearLayout level6 = findViewById(R.id.level6_animals);
        AnimationDrawable animated = (AnimationDrawable) level6.getBackground();
    ...
    public void addListenerOnButton() {
        ...
        btnDisplay_level6 = findViewById(R.id.choose);
        btnDisplay_level6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (radioShapeButton == truth) {
                    ...
                    Toast.makeText(Animal_Level6.this, "True", Toast.LENGTH_LONG).show();
                    Intent i = new Intent(getApplicationContext(), Animal_Level7.class);
                    startActivity(i);

                } else {
                    Toast.makeText(Animal_Level6.this,
