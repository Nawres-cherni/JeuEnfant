...
public class Color_Level4 extends AppCompatActivity {
    private Button btnDisplay;
    private EditText choice;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_color__level4);
        addListenerOnButton();
        background();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("orange")) {
                    Toast.makeText(Color_Level4.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Color_Level5.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Color_Level4.this,
