...
public class Color_Level5 extends AppCompatActivity {
    private Button btnDisplay;
    private EditText choice;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_color__level5);
        addListenerOnButton();
        background();
    }
        ...
        btnDisplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (choice.getText().toString().equals("pink")) {
                    Toast.makeText(Color_Level5.this, "True", Toast.LENGTH_SHORT).show();
                    Intent l = new Intent(getApplicationContext(), Color_Level6.class);
                    startActivity(l);

                } else {
                    Toast.makeText(Color_Level5.this,
